...
class LegalblinkPolicy_OptionsManager {
    ...
    protected function getOptionValueI18nString($optionValue) {
        switch ($optionValue) {
            case 'true':
                return __('true', 'legalblink-policy');
            case 'false':
                return __('false', 'legalblink-policy');

            case 'Administrator':
                return __('Administrator', 'legalblink-policy');
            case 'Editor':
                return __('Editor', 'legalblink-policy');
            case 'Author':
                return __('Author', 'legalblink-policy');
            case 'Contributor':
                return __('Contributor', 'legalblink-policy');
            case 'Subscriber':
                return __('Subscriber', 'legalblink-policy');
            case 'Anyone':
                return __('Anyone', 'legalblink-policy');
        }
        return $optionValue;
    }
